...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`relative inline-flex items-center justify-center rounded-full border-white/30 border-[1px] shadow-md ${className}`}
      tabIndex={0}
      role="button"
      aria-haspopup="true"
    >
...
export default function Dock({
  ...
  return (
    <motion.div
      ...
      className="flex max-w-full items-center justify-center relative z-10"
    >
      <motion.div
        onMouseMove={({ pageX }) => {
          isHovered.set(1);
